class Request < ActiveRecord::Base
  attr_accessible :description, :status, :start_date, :end_date, :employee_id, :title, :relevant_skill, :location_id, :group_id, :created_at
  belongs_to :employee
...
def calculate_distance_between_locations(latlong1, latlong2)
  dtor = Math::PI / 180
  r = 3959  #r is the radius in miles of the earth
