...
class RewardsControllerTest < ActionController::TestCase
  ...
  test "should create reward" do
    assert_difference('Reward.count') do
      post :create, reward: { commission_id: @reward.commission_id, employee_id: @reward.employee_id, request_id: @reward.request_id, reward_date: @reward.reward_date, skill_id: @reward.skill_id }
    end
  ...
  test "should update reward" do
    put :update, id: @reward, reward: { commission_id: @reward.commission_id, employee_id: @reward.employee_id, request_id: @reward.request_id, reward_date: @reward.reward_date, skill_id: @reward.skill_id }
    assert_redirected_to reward_path(assigns(:reward))
  end
